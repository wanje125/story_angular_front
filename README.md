...
you can buy products in the '/' homepage. If you click the add to cart you can add the product and the quantity on your cart. And if you click the picture of the product you can see the description of the product. In the cart you change your cart and if you want to buy you can click buy button. And it will navigate to the '/confirmation'. In there, you can buy the products by typing the forms.
